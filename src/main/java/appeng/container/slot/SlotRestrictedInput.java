...
public class SlotRestrictedInput extends AppEngSlot {
    ...
    public boolean isValid(final ItemStack is, final World theWorld) {
        if (this.which == PlacableItemType.VALID_ENCODED_PATTERN_W_OUTPUT) {
            final ICraftingPatternDetails ap
        ...
        switch (this.which) {
            case ENCODED_CRAFTING_PATTERN:
                if (i.getItem() instanceof ICraftingPatternItem) {
                    ...
                    final ICraftingPatternDetails de
                        = b.getPatternForItem(i, this.p.player.worldObj);
                    if (de != null) {
            ...
            case ENCODED_PATTERN: {
                ...
                // ICraftingPatternDetails pattern = i.getItem() instanceof
            ...
            case INSCRIBER_INPUT:
                return true; /*
                              * for (ItemStack is : Inscribe.inputs) if (
                              * Platform.isSameItemPrecise( is, i ) ) return true; return
                              * false;
                              */
            ...
            case WORKBENCH_CELL:
                return i.getItem() instanceof ICellWorkbenchItem
                    && ((ICellWorkbenchItem) i.getItem()).isEditable(i);
            ...
            case UPGRADES:
                return i.getItem() instanceof IUpgradeModule
                    && ((IUpgradeModule) i.getItem()).getType(i) != null;
            default:
                break;
        }
    ...
    public static boolean isMetalIngot(final ItemStack i) {
        ...
        for (final String name : new String[] { "Copper",
                                                "Tin",
                                                "Obsidian",
                                                "Iron",
                                                "Lead",
