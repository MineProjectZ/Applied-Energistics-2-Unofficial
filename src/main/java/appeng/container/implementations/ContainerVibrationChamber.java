...
public class ContainerVibrationChamber
    extends AEBaseContainer implements IProgressProvider {
    ...
    public ContainerVibrationChamber(
        final InventoryPlayer ip, final TileVibrationChamber vibrationChamber
    ) {
    ...
    public void detectAndSendChanges() {
        if (Platform.isServer()) {
            this.burnProgress = (int
                   ...
                   ? 0
                   : 12 * this.vibrationChamber.getBurnTime()
