...
public abstract class PartSharedItemBus extends PartUpgradeable implements IGridTickable {
    private final AppEngInternalAEInventory config
        = new AppEngInternalAEInventory(this, 9);
    ...
    protected boolean canDoBusWork() {
        ...
        return world != null
            && world.getChunkProvider().chunkExists(xCoordinate >> 4, zCoordinate >> 4);
    }
    ...
    private TileEntity
    getTileEntity(final TileEntity self, final int x, final int y, final int z) {
