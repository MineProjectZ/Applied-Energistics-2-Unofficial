...
public class PartLevelEmitter extends PartUpgradeable
    implements IEnergyWatcherHost, IStackWatcherHost, ICraftingWatcherHost,
    ...
    private final AppEngInternalAEInventory config
        = new AppEngInternalAEInventory(this, 1);
    ...
    public PartLevelEmitter(final ItemStack is) {
        ...
        this.getConfigManager().registerSetting(
            Settings.LEVEL_TYPE, LevelType.ITEM_LEVEL
        );
    ...
    public void setReportingValue(final long v) {
        ...
        if (this.getConfigManager().getSetting(Settings.LEVEL_TYPE)
    ...
    private boolean isLevelEmitterOn() {
        ...
        if (this.getInstalledUpgrades(Upgrades.CRAFTING) > 0) {
            try {
                return this.getProxy().getCrafting().isRequesting(
                    this.config.getAEStackInSlot(0)
                );
    ...
    @Override
    public void
    onRequestChange(final ICraftingGrid craftingGrid, final IAEItemStack what) {
        this.updateState();
    }
        ...
        if (this.getConfigManager().getSetting(Settings.LEVEL_TYPE)
            ...
            try {
                ...
                this.lastReportedValue
                    = (long) this.getProxy().getEnergy().getStoredPower();
                this.updateState();
    ...
    private void updateReportingValue(final IMEMonitor<IAEItemStack> monitor) {
        ...
        if (myStack == null) {
            ...
            final Collection<IAEItemStack> fuzzyList
    ...
    private void renderTorchAtAngle(double baseX, double baseY, double baseZ) {
        ...
        final IIcon IIcon
            = (isOn ? CableBusTextures.LevelEmitterTorchOn.getIcon() : offTexture);
        //
        ...
        /*
         * double d5 = (double)IIcon.func_94209_e(); double d6 =
         * (double)IIcon.func_94206_g(); double d7 = (double)IIcon.func_94212_f(); double
         * d8 = (double)IIcon.func_94210_h(); double d9 =
         * (double)IIcon.func_94214_a(7.0D); double d10 =
         * (double)IIcon.func_94207_b(6.0D); double d11 =
         * (double)IIcon.func_94214_a(9.0D); double d12 =
         * (double)IIcon.func_94207_b(8.0D); double d13 =
         * (double)IIcon.func_94214_a(7.0D); double d14 =
         * (double)IIcon.func_94207_b(13.0D); double d15 =
         * (double)IIcon.func_94214_a(9.0D); double d16 =
         * (double)IIcon.func_94207_b(15.0D);
         */
        ...
        /*
         * float var16 = (float)var14 / 256.0F; float var17 = ((float)var14 + 15.99F) /
         * 256.0F; float var18 = (float)var15 / 256.0F; float var19 = ((float)var15
         * + 15.99F) / 256.0F;
         */
        ...
        this.addVertexWithUV(
            baseX + var44 + Zero, baseY, baseZ - var44 + par10, var32, var30
        );
        this.addVertexWithUV(
            baseX + var44 + Zero, baseY, baseZ + var44 + par10, var32, var34
        );
        this.addVertexWithUV(
            baseX - var44 + Zero, baseY, baseZ + var44 + par10, var28, var34
        );
        this.addVertexWithUV(
            baseX - var44 + Zero, baseY, baseZ - var44 + par10, var28, var30
        );

        this.addVertexWithUV(baseX - var44, baseY + 1.0D, var40, var16, var18);
        this.addVertexWithUV(
            baseX - var44 + Zero, baseY + 0.0D, var40 + par10, var16, var19
        );
        this.addVertexWithUV(
            baseX - var44 + Zero, baseY + 0.0D, var42 + par10, var17, var19
        );
        ...
        this.addVertexWithUV(
            baseX + Zero + var44, baseY + 0.0D, var42 + par10, var16, var19
        );
        this.addVertexWithUV(
            baseX + Zero + var44, baseY + 0.0D, var40 + par10, var17, var19
        );
        ...
        this.addVertexWithUV(
            var36 + Zero, baseY + 0.0D, baseZ + var44 + par10, var16, var19
        );
        this.addVertexWithUV(
            var38 + Zero, baseY + 0.0D, baseZ + var44 + par10, var17, var19
        );
        ...
        this.addVertexWithUV(
            var38 + Zero, baseY + 0.0D, baseZ - var44 + par10, var16, var19
        );
        this.addVertexWithUV(
            var36 + Zero, baseY + 0.0D, baseZ - var44 + par10, var17, var19
        );
        this.addVertexWithUV(var36, baseY + 1.0D, baseZ - var44, var17, var18);
    }

    private void
    addVertexWithUV(double x, double y, double z, final double u, final double v) {
        final Tessellator var12 = Tessellator.instance;
    ...
    public void renderStatic(
        ...
        tess.setBrightness(rh.getBlock().getMixedBrightnessForBlock(
            this.getHost().getTile().getWorldObj(), x, y, z
        ));
    ...
    public void randomDisplayTick(
        ...
        if (this.isLevelEmitterOn()) {
            ...
            world.spawnParticle(
                "reddust", 0.5 + x + d0, 0.5 + y + d1, 0.5 + z + d2, 0.0D, 0.0D, 0.0D
            );
        }
    }
    ...
    public boolean onPartActivate(final EntityPlayer player, final Vec3 pos) {
        if (!player.isSneaking()) {
            ...
            Platform.openGUI(
                player,
                this.getHost().getTile(),
                this.getSide(),
                GuiBridge.GUI_LEVEL_EMITTER
            );
            return true;
        }
    ...
    public void provideCrafting(final ICraftingProviderHelper craftingTracker) {
        if (this.getInstalledUpgrades(Upgrades.CRAFTING) > 0) {
            if (this.getConfigManager().getSetting(Settings.CRAFT_VIA_REDSTONE)
                == YesNo.YES) {
