 ...
 * <p>
 * Opposed to the other subclass of {@link AbstractPartReporting}, it will only use the
 * bright front texture.
 *
 * @author AlgorithmX2
 * @author yueh
 * @version rv3
...
public abstract class AbstractPartPanel extends AbstractPartReporting {
    private static final CableBusTextures FRONT_BRIGHT_ICON
        = CableBusTextures.PartMonitor_Bright;
    private static final CableBusTextures FRONT_DARK_ICON
        = CableBusTextures.PartMonitor_Colored;
    ...
    /**
     * How bright the color the panel should appear. Usually it depends on a {@link
     * AEColor} variant. This does not affect the actual light level of the part.
     *
