...
public class PartCraftingTerminal
    extends AbstractPartTerminal implements ICraftingTerminal {
    private static final CableBusTextures FRONT_BRIGHT_ICON
        = CableBusTextures.PartCraftingTerm_Bright;
    private static final CableBusTextures FRONT_DARK_ICON
        = CableBusTextures.PartCraftingTerm_Dark;
    private static final CableBusTextures FRONT_COLORED_ICON
        = CableBusTextures.PartCraftingTerm_Colored;
    ...
    public GuiBridge getGui(final EntityPlayer p) {
        ...
        if (GuiBridge.GUI_CRAFTING_TERMINAL.hasPermissions(
