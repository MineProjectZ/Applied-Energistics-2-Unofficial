...
public class LayerIFluidHandler extends LayerBase implements IFluidHandler {
    ...
    @Override
    public boolean
    canFill(final ForgeDirection from, final net.minecraftforge.fluids.Fluid fluid) {
        final IPart part = this.getPart(from);
        if (part instanceof IFluidHandler) {
    ...
    @Override
    public boolean
    canDrain(final ForgeDirection from, final net.minecraftforge.fluids.Fluid fluid) {
        final IPart part = this.getPart(from);
        if (part instanceof IFluidHandler) {
