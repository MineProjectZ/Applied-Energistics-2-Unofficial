...
public class PneumaticCraft implements IIntegrationModule {
    ...
    public PneumaticCraft() {
        IntegrationHelper
            .testClassExistence(this, pneumaticCraft.api.block.BlockSupplier.class);
        IntegrationHelper.testClassExistence(
            this, pneumaticCraft.api.tileentity.ISidedPneumaticMachine.class
        );
        IntegrationHelper.testClassExistence(
            this, pneumaticCraft.api.tileentity.AirHandlerSupplier.class
        );
        IntegrationHelper
            .testClassExistence(this, pneumaticCraft.api.tileentity.IAirHandler.class);
    }
    ...
    private void registerPressureAttunement(final String itemID) {
        ...
        final ItemStack modItem
            = GameRegistry.findItemStack(PNEUMATIC_CRAFT_MOD_ID, itemID, 1);
