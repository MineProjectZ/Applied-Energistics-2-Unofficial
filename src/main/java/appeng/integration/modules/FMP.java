...
public class FMP implements IIntegrationModule, IPartFactory, IPartConverter, IFMP {
    ...
    private void
    addBlockTypes(final Collection<Block> blockTypes, final IBlockDefinition definition) {
    ...
    public IPartHost getOrCreateHost(final TileEntity tile) {
        try {
            ...
            final TileMultipart mp
                = TileMultipart.getOrConvertTile(tile.getWorldObj(), loc);
            if (mp != null) {
