...
public final class PartWailaDataProvider implements IWailaDataProvider {
    ...
    public PartWailaDataProvider() {
        ...
        final IPartWailaDataProvider storageMonitor
            = new StorageMonitorWailaDataProvider();
        ...
        this.providers = Lists.newArrayList(
            channel, storageMonitor, powerState, partStack, p2pState
        );
    }

    @Override
    public ItemStack
    getWailaStack(final IWailaDataAccessor accessor, final IWailaConfigHandler config) {
