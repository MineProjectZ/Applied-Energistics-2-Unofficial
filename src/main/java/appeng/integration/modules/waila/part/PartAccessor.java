...
public final class PartAccessor {
    /**
     * Hits a {@link appeng.api.parts.IPartHost} with {@link
     * net.minecraft.util.MovingObjectPosition}. <p/> You can derive the looked at {@link
     * appeng.api.parts.IPart} by doing that. If a facade is being looked at, it is
     ...
     */
    public Optional<IPart>
    getMaybePart(final TileEntity te, final MovingObjectPosition mop) {
