...
public class ImmibisMicroblocks implements IImmibisMicroblocks, IIntegrationModule {
    ...
    public ImmibisMicroblocks() {
        IntegrationHelper.testClassExistence(
            this, mods.immibis.core.api.multipart.IMultipartTile.class
        );
        IntegrationHelper
            .testClassExistence(this, mods.immibis.core.api.multipart.ICoverSystem.class);
        IntegrationHelper.testClassExistence(
            this, mods.immibis.core.api.multipart.IPartContainer.class
        );
    }
    ...
    public void init() throws Throwable {
        try {
            this.MicroblockAPIUtils
                = Class.forName("mods.immibis.microblocks.api.MicroblockAPIUtils");
    ...
    @Override
    public IPartHost
    getOrCreateHost(final EntityPlayer player, final int side, final TileEntity te) {
        ...
        if (te instanceof IMultipartTile && this.canConvertTiles && isPartItem) {
            ...
            final boolean multiPartPresent
                = maybeMultiPartBlock.isPresent() && maybeMultiPartStack.isPresent();
