...
public class RC implements IRC, IIntegrationModule {
    ...
    public RC() {
        IntegrationHelper.testClassExistence(
            this, mods.railcraft.api.crafting.RailcraftCraftingManager.class
        );
        IntegrationHelper.testClassExistence(
            this, mods.railcraft.api.crafting.IRockCrusherRecipe.class
        );
    }

    @Override
    public void rockCrusher(final ItemStack input, final ItemStack output) {
        final IRockCrusherRecipe re
            = RailcraftCraftingManager.rockCrusher.createNewRecipe(input, true, true);
