...
public final class BuildCraftCore implements IBuildCraftCore, IIntegrationModule {
    ...
    public BuildCraftCore() {
        ...
        IntegrationHelper
            .testClassExistence(this, buildcraft.api.tools.IToolWrench.class);
    }
    ...
    public boolean canWrench(
        @Nonnull final Item wrench,
        final EntityPlayer wrencher,
        final int x,
        final int y,
        final int z
    ) {
    ...
    private void registerPowerP2P() {
        ...
        registry.addNewAttunement(
            new ItemStack(buildcraft.BuildCraftCore.engineBlock, 1, 0),
            TunnelType.RF_POWER
        );
        registry.addNewAttunement(
            new ItemStack(buildcraft.BuildCraftCore.engineBlock, 1, 1),
            TunnelType.RF_POWER
        );
        registry.addNewAttunement(
            new ItemStack(buildcraft.BuildCraftCore.engineBlock, 1, 2),
            TunnelType.RF_POWER
        );
    }
}
