        ...
        if (is != null) {
            if (input.equals(is)) {
                ...
                if (storedItems > max) {
                    ...
                    if (mode == Actionable.MODULATE) {
                        this.dsu.setStoredItemCount(
                            is.stackSize + (int) input.getStackSize()
                        );
                    }
                    return null;
                }
            ...
            if (mode == Actionable.MODULATE) {
                this.dsu.setStoredItemType(
                    input.getItemStack(), (int) input.getStackSize()
                );
            }
            return null;
        }
    ...
    public IAEItemStack extractItems(
        ...
        if (request.equals(is)) {
            if (request.getStackSize() >= is.stackSize) {
                ...
                if (mode == Actionable.MODULATE) {
                    this.dsu.setStoredItemCount(
                        is.stackSize - (int) request.getStackSize()
                    );
                }
                return request.copy();
            }
