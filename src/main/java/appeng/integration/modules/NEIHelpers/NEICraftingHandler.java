            ...
            if (gui instanceof GuiCraftingTerm || gui instanceof GuiPatternTerm) {
                for (final PositionedStack positionedStack : ingredients) {
                    ...
                    if (positionedStack.items != null
                        && positionedStack.items.length > 0) {
                        for (final Slot slot :
                            ...
                            if (slot instanceof SlotCraftingMatrix
                                ...
                                if (slot.getSlotIndex() == col + row * 3) {
                                    ...
                                    for (int x = 0; x < positionedStack.items.length;
                                         x++) {
                                        if (Platform.isRecipePrioritized(
                                                positionedStack.items[x]
                                            )) {
