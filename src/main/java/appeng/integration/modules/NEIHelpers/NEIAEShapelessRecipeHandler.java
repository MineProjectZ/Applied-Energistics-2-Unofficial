...
public class NEIAEShapelessRecipeHandler extends TemplateRecipeHandler {
    ...
    public void loadCraftingRecipes(final String outputId, final Object... results) {
        if ((outputId.equals("crafting"))
            && (this.getClass() == NEIAEShapelessRecipeHandler.class)) {
    ...
    private class CachedShapelessRecipe extends TemplateRecipeHandler.CachedRecipe {
        ...
        public List<PositionedStack> getIngredients() {
            return this.getCycledIngredients(
                NEIAEShapelessRecipeHandler.this.cycleticks / 20, this.ingredients
            );
        }
                    ...
                    if (items.length > (y * 3 + x)) {
                        ...
                        try {
                            ...
                            final PositionedStack stack = new PositionedStack(
                                useSingleItems ? Platform.findPreferred(is)
                                               : ing.getItemStackSet(),
                                25 + x * 18,
                                6 + y * 18,
                                false
