...
public interface ISlimReadableNumberConverter {
    /**
     * Converts a number into a human readable form. It will not round the number, but
     * down it. Will try to cut the number down 1 decimal later, but rarely because of the
     * 3 width limitation. Can only handle non negative numbers <p> Example: 10000L -> 10K
