...
public final class AEFluidStack
    extends AEStack<IAEFluidStack> implements IAEFluidStack, Comparable<AEFluidStack> {
    ...
    public static IAEFluidStack loadFluidStackFromPacket(final ByteBuf data)
        throws IOException {
    ...
    public void writeToNBT(final NBTTagCompound i) {
        ...
        /*
         * NBTBase FluidName = i.getTag( "FluidName" ); NBTBase Count = i.getTag( "Count"
         * ); NBTBase Cnt = i.getTag( "Cnt" ); NBTBase Req = i.getTag( "Req" ); NBTBase
         * Craft = i.getTag( "Craft" );
         */

        /*
         * if ( FluidName != null && FluidName instanceof NBTTagString ) ((NBTTagString)
         * FluidName).data = (String) this.fluid.getName(); else
         */
    ...
    public boolean equals(final Object ia) {
        if (ia instanceof AEFluidStack) {
            return ((AEFluidStack) ia).fluid == this.fluid
                && this.tagCompound == ((AEFluidStack) ia).tagCompound;
    ...
    public FluidStack getFluidStack() {
        final FluidStack is = new FluidStack(
            this.fluid, (int) Math.min(Integer.MAX_VALUE, this.getStackSize())
        );
        if (this.tagCompound != null) {
