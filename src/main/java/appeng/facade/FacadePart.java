...
public class FacadePart implements IFacadePart, IBoxProvider {
                    ...
                    if (randomItem.getItem() instanceof ItemBlock) {
                        ...
                        if (rbw != null) {
                            ...
                            if (this.prevLight != null
                                && rbw.similarLighting(
                                    blk, rbw.blockAccess, x, y, z, this.prevLight
                                )) {
                            ...
                            rbw.setFaces(this.calculateFaceOpenFaces(
                                rbw.blockAccess, fc, x, y, z, this.side
                            ));
                        ...
                        if (busBounds == null) {
                            if (this.side == ForgeDirection.UP
                ...
                if (fi != null) {
                    ...
                    if (randomItem != null) {
                        if (randomItem.getItem() instanceof ItemBlock) {
                            ...
                            Tessellator.instance.setColorOpaque_F(1, 1, 1);
                            instance.setTexture(blk.getIcon(
                                this.side.ordinal(),
                                ib.getMetadata(randomItem.getItemDamage())
                            ));
    ...
    private ItemStack getTexture() {
        ...
        } else if (IntegrationRegistry.INSTANCE.isEnabled(
                       IntegrationType.BuildCraftTransport
                   )) {
