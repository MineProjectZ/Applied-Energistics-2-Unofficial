...
public class PlayerSecurityWrapper implements ISecurityRegistry {
    ...
    public PlayerSecurityWrapper(
        final HashMap<Integer, EnumSet<SecurityPermissions>> playerPerms
    ) {
    ...
    @Override
    public void
    addPlayer(final int playerID, final EnumSet<SecurityPermissions> permissions) {
