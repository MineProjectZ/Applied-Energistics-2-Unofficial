...
public final class CraftingCPUCluster implements IAECluster, ICraftingCPU {
    ...
    /**
     * add a new Listener to the monitor, be sure to properly remove yourself when your
     * done.
     */
    @Override
    ...
    private Iterator<Entry<IMEMonitorHandlerReceiver<IAEItemStack>, Object>>
    getListeners() {
            ...
            if (details.isCraftable()) {
                ...
                for (IAEItemStack fuzz :
                    ...
                    final IAEItemStack ais = this.inventory.extractItems(
                        fuzz, Actionable.SIMULATE, this.machineSrc
                    );
                ...
                final IAEItemStack ais = this.inventory.extractItems(
                    g.copy(), Actionable.SIMULATE, this.machineSrc
                );
                final ItemStack is = ais == null ? null : ais.getItemStack();
    ...
    private void storeItems() {
        ...
        for (IAEItemStack is : this.inventory.getItemList()) {
            is = this.inventory.extractItems(
                is.copy(), Actionable.MODULATE, this.machineSrc
            );
    ...
    public ICraftingLink submitJob(
        ...
        if (this.isBusy() || !this.isActive()
            || this.availableStorage < job.getByteTotal()) {
            return null;
        }
    ...
    private NBTTagCompound generateLinkData(
    ...
    private static class TaskProgress { private long value; }
}
