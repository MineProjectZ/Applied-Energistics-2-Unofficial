...
public class RecipeHandlerRegistry implements IRecipeHandlerRegistry {
    ...
    private final Collection<ISubItemResolver> resolvers
        = new LinkedList<ISubItemResolver>();

    @Override
    public void
    addNewCraftHandler(final String name, final Class<? extends ICraftHandler> handler) {
