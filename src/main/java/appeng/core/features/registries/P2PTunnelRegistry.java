...
public final class P2PTunnelRegistry implements IP2PTunnelRegistry {
    ...
    private final Map<ItemStack, TunnelType> tunnels
        = new HashMap<ItemStack, TunnelType>(INITIAL_CAPACITY);
    ...
    public void configure() {
        ...
        this.addNewAttunement(
            new ItemStack(Blocks.unpowered_comparator), TunnelType.REDSTONE
        );
        this.addNewAttunement(
            new ItemStack(Blocks.powered_comparator), TunnelType.REDSTONE
        );
        this.addNewAttunement(
            new ItemStack(Blocks.powered_repeater), TunnelType.REDSTONE
        );
        this.addNewAttunement(
            new ItemStack(Blocks.unpowered_repeater), TunnelType.REDSTONE
        );
        this.addNewAttunement(
            new ItemStack(Blocks.daylight_detector), TunnelType.REDSTONE
        );
        ...
        this.addNewAttunement(
            this.getModItem(
                "EnderIO", "itemRedstoneConduit", OreDictionary.WILDCARD_VALUE
            ),
            TunnelType.REDSTONE
        );
        ...
        this.addNewAttunement(
            this.getModItem("ExtraUtilities", "extractor_base", 0), TunnelType.ITEM
        );
        this.addNewAttunement(
            this.getModItem("Mekanism", "PartTransmitter", 9), TunnelType.ITEM
        );
        this.addNewAttunement(
        ...
        this.addNewAttunement(
            this.getModItem("ThermalDynamics", "ThermalDynamics_32", 0), TunnelType.ITEM
        );
        ...
        this.addNewAttunement(
            this.getModItem("Mekanism", "MachineBlock2", 11), TunnelType.FLUID
        );
        this.addNewAttunement(
            this.getModItem("Mekanism", "PartTransmitter", 4), TunnelType.FLUID
        );
        this.addNewAttunement(
            this.getModItem("ExtraUtilities", "extractor_base", 6), TunnelType.FLUID
        );
        this.addNewAttunement(
        ...
        this.addNewAttunement(
            this.getModItem("ThermalDynamics", "ThermalDynamics_16", 0), TunnelType.FLUID
        );
    ...
    @Override
    public void
    addNewAttunement(@Nullable final ItemStack trigger, @Nullable final TunnelType type) {
    ...
    private void
    addNewAttunement(final IItemDefinition definition, final TunnelType type) {
