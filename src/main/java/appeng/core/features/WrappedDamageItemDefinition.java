...
public final class WrappedDamageItemDefinition implements ITileDefinition {
    ...
    public WrappedDamageItemDefinition(
        final ITileDefinition definition, final int damage
    ) {
    ...
    public Optional<ItemStack> maybeStack(final int stackSize) {
        return this.definition.maybeBlock().transform(
            new BlockTransformFunction(stackSize, this.damage)
        );
    }
    ...
    public boolean isSameAs(final ItemStack comparableStack) {
        ...
        final boolean sameItem
            = this.definition.isSameAs(new ItemStack(comparableStack.getItem()));
    ...
    isSameAs(final IBlockAccess world, final int x, final int y, final int z) {
        return this.definition.isSameAs(world, x, y, z)
            && world.getBlockMetadata(x, y, z) == this.damage;
    }
