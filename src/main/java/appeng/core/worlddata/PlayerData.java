...
final class PlayerData implements IWorldPlayerData, IOnWorldStartable, IOnWorldStoppable {
    ...
    public int getPlayerID(@Nonnull final GameProfile profile) {
        ...
        if (maybePlayerID != null && maybePlayerID.isIntValue()) {
            ...
            final Property newPlayer
                = new Property(uuid, String.valueOf(newPlayerID), Property.Type.INTEGER);
    ...
    private int nextPlayer() {
        ...
        this.lastPlayerID++;
        this.config.get(LAST_PLAYER_CATEGORY, LAST_PLAYER_KEY, this.lastPlayerID)
    ...
    public void onWorldStart() {
        this.lastPlayerID
            = this.config.get(LAST_PLAYER_CATEGORY, LAST_PLAYER_KEY, LAST_PLAYER_DEFAULT)
