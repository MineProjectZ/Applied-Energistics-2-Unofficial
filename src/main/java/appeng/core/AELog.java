...
public final class AELog {
    ...
    private static Logger getLogger() {
        final String loggerName
            = LOGGER_PREFIX + (Platform.isServer() ? SERVER_SUFFIX : CLIENT_SUFFIX);
    ...
    public static boolean isLogEnabled() {
        return AEConfig.instance == null
            || AEConfig.instance.isFeatureEnabled(AEFeature.Logging);
    }

    /**
     * Logs a formatted message with a specific log level.
     * <p>
     * This uses {@link String#format(String, Object...)} as opposed to the {@link
     * ParameterizedMessage} to allow a more flexible formatting. <p> The output can be
     * globally disabled via the configuration file.
     *
     ...
     */
    public static void
    log(@Nonnull final Level level, @Nonnull final String message, final Object... params
    ) {
    ...
    /**
     * Log an exception with a custom message formated via {@link String#format(String,
     * Object...)} <p> Similar to {@link AELog#log(Level, String, Object...)}.
     *
     * @param level     the intended level.
     * @param exception
     * @param message   the message to be formatted.
     ...
     */
    public static void
    info(@Nonnull final Throwable exception, @Nonnull final String message) {
     ...
     */
    public static void
    warn(@Nonnull final Throwable exception, @Nonnull final String message) {
     ...
     */
    public static void
    error(@Nonnull final Throwable exception, @Nonnull final String message) {
     ...
     */
    public static void
    debug(@Nonnull final Throwable exception, @Nonnull final String message) {
        if (AELog.isDebugLogEnabled()) {
    ...
    /**
     * A specialized logging for grinder recipes, can be disabled inside configuration
     * file.
     *
     ...
     */
    public static void
    craftingDebug(@Nonnull final String message, final Object... params) {
