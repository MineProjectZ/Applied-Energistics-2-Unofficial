...
/**
 * Can differentiate if a {@link net.minecraft.entity.player.EntityPlayer} is a real
 * player or not
 *
 * @author thatsIch
 * @since rv2
...
public class PlayerDifferentiator {
    /**
     * Can determine if an {@link net.minecraft.entity.player.EntityPlayer} is not a real
     * player. This is based on if the {@param player} is:
     * - null
     * - dead
     * - fake
     *
