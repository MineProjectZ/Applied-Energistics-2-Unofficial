...
public class GuiImgButton extends GuiButton implements ITooltip {
    ...
    public GuiImgButton(final int x, final int y, final Enum idx, final Enum val) {
        ...
        if (appearances == null) {
            ...
            this.registerApp(
                ...
                Settings.ACTIONS,
                ActionItems.STASH,
                ButtonToolTips.Stash,
                ButtonToolTips.StashDesc
            );
    ...
    private void registerApp(
        ...
        a.displayValue = (String
        ) (hint instanceof String ? hint : ((ButtonToolTips) hint).getUnlocalized());
        a.index = iconIndex;
