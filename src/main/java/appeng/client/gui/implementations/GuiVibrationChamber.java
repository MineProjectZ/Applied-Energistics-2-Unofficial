...
public class GuiVibrationChamber extends AEBaseGui {
    ...
    public GuiVibrationChamber(
        final InventoryPlayer inventoryPlayer, final TileVibrationChamber te
    ) {
    ...
    public void initGui() {
        ...
        this.pb = new GuiProgressBar(
            this.cvc, "guis/vibchamber.png", 99, 36, 176, 14, 6, 18, Direction.VERTICAL
        );
    ...
    drawFG(final int offsetX, final int offsetY, final int mouseX, final int mouseY) {
        this.fontRendererObj.drawString(
            this.getGuiDisplayName(GuiText.VibrationChamber.getLocal()), 8, 6, 4210752
        );
        this.fontRendererObj.drawString(
        ...
        this.pb.setFullMsg(
            this.cvc.getAePerTick() * this.cvc.getCurrentProgress() / 100 + " AE/t"
        );
