...
public class GuiNetworkStatus extends AEBaseGui implements ISortSource {
    ...
    public GuiNetworkStatus(
        final InventoryPlayer inventoryPlayer, final INetworkTool te
    ) {
    ...
    drawFG(final int offsetX, final int offsetY, final int mouseX, final int mouseY) {
        ...
        this.fontRendererObj.drawString(
            GuiText.MaxPower.getLocal() + ": "
                + Platform.formatPowerLong(ns.getMaxPower(), false),
            13,
            26,
            4210752
        );
        ...
        this.fontRendererObj.drawString(
            GuiText.PowerInputRate.getLocal() + ": "
                + Platform.formatPowerLong(ns.getAverageAddition(), true),
            13,
            143 - 10,
            4210752
        );
