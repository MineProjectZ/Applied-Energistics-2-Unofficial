    ...
    public List<String> handleItemTooltip(
        ...
        if (stack != null) {
            ...
            if (s instanceof SlotME) {
                final int BigNumber
                    = AEConfig.instance.useTerminalUseLargeFont() ? 999 : 9999;
                ...
                if (myStack != null) {
                    if (myStack.getStackSize() > BigNumber
                        || (myStack.getStackSize() > 1 && stack.isItemDamaged())) {
                        final String local = ButtonToolTips.ItemsStored.getLocal();
                        final String formattedAmount
                            = NumberFormat.getNumberInstance(Locale.US).format(
                                myStack.getStackSize()
                            );
    ...
    protected void renderToolTip(final ItemStack stack, final int x, final int y) {
        ...
        if (s instanceof SlotME && stack != null) {
            ...
            if (myStack != null) {
                ...
                final List<String> currentToolTip = stack.getTooltip(
                ...
                final List var4 = stack.getTooltip(
                    this.mc.thePlayer, this.mc.gameSettings.advancedItemTooltips
                );
                var4.add(
                    "Items Stored: "
