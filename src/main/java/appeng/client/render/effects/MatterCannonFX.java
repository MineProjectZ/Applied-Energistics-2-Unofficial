...
public class MatterCannonFX extends EntityBreakingFX {
    ...
    public MatterCannonFX(
        ...
        this.particleTextureIndex
            = ExtraBlockTextures.BlockMatterCannonParticle.getIcon();
        this.noClip = true;
    }
    ...
    public void renderParticle(
        ...
        final float f11
            = (float) (this.prevPosX + (this.posX - this.prevPosX) * par2 - interpPosX);
        final float f12
            = (float) (this.prevPosY + (this.posY - this.prevPosY) * par2 - interpPosY);
        final float f13
            = (float) (this.prevPosZ + (this.posZ - this.prevPosZ) * par2 - interpPosZ);
