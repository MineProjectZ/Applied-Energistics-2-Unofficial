    ...
    public void renderItemOverlayIntoGUI(
        ...
        if (is != null) {
            final float scaleFactor
                = AEConfig.instance.useTerminalUseLargeFont() ? 0.85f : 0.5f;
            ...
            if (is.stackSize == 0) {
                ...
                final int X = (int
                ) (((float) par4 + offset + 16.0f
                    - fontRenderer.getStringWidth(craftLabelText) * scaleFactor)
                   * inverseScaleFactor);
                final int Y = (int
                ) (((float) par5 + offset + 16.0f - 7.0f * scaleFactor)
                   * inverseScaleFactor);
            ...
            final long amount
                = this.aeStack != null ? this.aeStack.getStackSize() : is.stackSize;
            ...
            if (amount != 0) {
                ...
                final int X = (int
                    ...
                    - fontRenderer.getStringWidth(stackSize) * scaleFactor)
                   * inverseScaleFactor);
                final int Y = (int
                ) (((float) par5 + offset + 16.0f - 7.0f * scaleFactor)
                   * inverseScaleFactor);
