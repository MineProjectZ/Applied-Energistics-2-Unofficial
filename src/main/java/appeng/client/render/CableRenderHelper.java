...
public class CableRenderHelper {
    ...
    public void renderStatic(
        final CableBusContainer cableBusContainer, final IFacadeContainer iFacadeContainer
    ) {
        ...
        for (final ForgeDirection s : ForgeDirection.values()) {
            ...
            if (part != null) {
                ...
                renderer.uvRotateBottom = renderer.uvRotateEast = renderer.uvRotateNorth
                    = renderer.uvRotateSouth = renderer.uvRotateTop
                    = renderer.uvRotateWest = 0;

                part.renderStatic(
                    te.xCoord, te.yCoord, te.zCoord, BusRenderHelper.INSTANCE, renderer
                );
    ...
    public void renderDynamic(
        final CableBusContainer cableBusContainer,
        final double x,
        final double y,
        final double z
    ) {
        for (final ForgeDirection s : ForgeDirection.values()) {
            ...
            if (part != null) {
                ...
                BusRenderHelper.INSTANCE.setOrientation(ax, ay, az);
                part.renderDynamic(
                    x, y, z, BusRenderHelper.INSTANCE, BusRenderer.INSTANCE.getRenderer()
                );
            }
        }
    }
