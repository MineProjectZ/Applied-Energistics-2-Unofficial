...
public class RenderBlocksWorkaround extends RenderBlocks {
        ...
        try {
            if (this.fBrightness == null) {
                try {
                    ...
                    this.fBrightness
                        = Tessellator.class.getDeclaredField("field_78401_l");
                }
    ...
    void setTexture(final IIcon ico) {
        this.lightState.rXPos = this.lightState.rXNeg = this.lightState.rYPos
            = this.lightState.rYNeg = this.lightState.rZPos = this.lightState.rZNeg = ico;
    }
    ...
    private boolean renderStandardBlockNoCalculations(
        final Block b, final int x, final int y, final int z
    ) {
        ...
        this.renderFaceXPos(
            ...
            this.isUseTextures()
                ...
                : this.getBlockIcon(
                    b, this.blockAccess, x, y, z, ForgeDirection.EAST.ordinal()
                )
        );
        ...
        this.renderFaceXNeg(
            ...
            this.isUseTextures()
                ...
                : this.getBlockIcon(
                    b, this.blockAccess, x, y, z, ForgeDirection.WEST.ordinal()
                )
        );
        ...
        this.renderFaceYPos(
            ...
            this.isUseTextures()
                ...
                : this.getBlockIcon(
                    b, this.blockAccess, x, y, z, ForgeDirection.UP.ordinal()
                )
        );
        ...
        this.renderFaceYNeg(
            ...
            this.isUseTextures()
                ...
                : this.getBlockIcon(
                    b, this.blockAccess, x, y, z, ForgeDirection.DOWN.ordinal()
                )
        );
        ...
        this.renderFaceZPos(
            ...
            this.isUseTextures()
                ...
                : this.getBlockIcon(
                    b, this.blockAccess, x, y, z, ForgeDirection.SOUTH.ordinal()
                )
        );
        ...
        this.renderFaceZNeg(
            ...
            this.isUseTextures()
                ...
                : this.getBlockIcon(
                    b, this.blockAccess, x, y, z, ForgeDirection.NORTH.ordinal()
                )
        );
    ...
    @Override
    public boolean
    renderStandardBlock(final Block blk, final int x, final int y, final int z) {
        try {
            if (this.isCalculations()) {
                this.lightState.lightHash
                    = this.getLightingHash(blk, this.blockAccess, x, y, z);
    ...
    public void renderFaceZNeg(
        ...
        if (this.getFaces().contains(ForgeDirection.NORTH)) {
            ...
            if (this.isFacade()) {
                ...
                final double d3
                    = par8Icon.getInterpolatedU(16.0D - this.renderMinX * 16.0D);
                final double d4
                    = par8Icon.getInterpolatedU(16.0D - this.renderMaxX * 16.0D);
                final double d5
                    = par8Icon.getInterpolatedV(16.0D - this.renderMaxY * 16.0D);
                final double d6
                    = par8Icon.getInterpolatedV(16.0D - this.renderMinY * 16.0D);
    ...
    public void renderFaceXPos(
        ...
        if (this.getFaces().contains(ForgeDirection.EAST)) {
            ...
            if (this.isFacade()) {
                ...
                final double d3
                    = par8Icon.getInterpolatedU(16.0D - this.renderMinZ * 16.0D);
                final double d4
                    = par8Icon.getInterpolatedU(16.0D - this.renderMaxZ * 16.0D);
                final double d5
                    = par8Icon.getInterpolatedV(16.0D - this.renderMaxY * 16.0D);
                final double d6
                    = par8Icon.getInterpolatedV(16.0D - this.renderMinY * 16.0D);
    ...
    private void partialLightingColoring(final double u, final double v) {
        ...
        final double rB
            = this.colorRedBottomLeft * u + (1.0 - u) * this.colorRedBottomRight;
        final float r = (float) (rA * v + rB * (1.0 - v));

        final double gA
            = this.colorGreenTopLeft * u + (1.0 - u) * this.colorGreenTopRight;
        final double gB
            = this.colorGreenBottomLeft * u + (1.0 - u) * this.colorGreenBottomRight;
        final float g = (float) (gA * v + gB * (1.0 - v));

        final double bA = this.colorBlueTopLeft * u + (1.0 - u) * this.colorBlueTopRight;
        final double bB
            = this.colorBlueBottomLeft * u + (1.0 - u) * this.colorBlueBottomRight;
        ...
        final double lowA = ((this.brightnessTopLeft & 255)) * u
            + (1.0 - u) * ((this.brightnessTopRight & 255));
        final double lowB = ((this.brightnessBottomLeft & 255)) * u
            + (1.0 - u) * ((this.brightnessBottomRight & 255));
    ...
    private int getLightingHash(
        final Block blk, final IBlockAccess w, final int x, final int y, final int z
    ) {
        int o = 0;
        ...
        for (int i = -1; i <= 1; i++) {
            for (int j = -1; j <= 1; j++) {
                for (int k = -1; k <= 1; k++) {
                    this.lightHashTmp[o] = blk.getMixedBrightnessForBlock(
                        this.blockAccess, x + i, y + j, z + k
                    );
                    o++;
                }
            }
