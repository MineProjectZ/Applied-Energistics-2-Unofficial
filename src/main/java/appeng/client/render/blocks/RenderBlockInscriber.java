...
public class RenderBlockInscriber extends BaseBlockRender<BlockInscriber, TileInscriber> {
    ...
    public void renderInventory(
        ...
        blk.getRendererInstance().setTemporaryRenderIcon(
            ExtraBlockTextures.BlockInscriberInside.getIcon()
        );
    ...
    public void renderTile(
        ...
        // << 20 | light << 4;
        final int br = tile.getWorldObj().getLightBrightnessForSkyBlocks(
        ...
        tess.addVertexWithUV(
            TwoPx, middle + press, TwoPx, ic.getInterpolatedU(2), ic.getInterpolatedV(2)
        );
        tess.addVertexWithUV(
            1.0 - TwoPx,
            middle + press,
        ...
        tess.addVertexWithUV(
            TwoPx, middle - press, TwoPx, ic.getInterpolatedU(14), ic.getInterpolatedV(2)
        );
        tess.addVertexWithUV(
            TwoPx,
            middle - press,
        ...
        if (relativeProgress > 1.0f || items == 0) {
            ...
            this.renderItem(
                tile.getStackInSlot(0), press, block, tile, tess, x, y, z, f, renderer
            );
            this.renderItem(
                tile.getStackInSlot(1), -press, block, tile, tess, x, y, z, f, renderer
            );
            this.renderItem(
                tile.getStackInSlot(2), 0.0f, block, tile, tess, x, y, z, f, renderer
            );
        }
        ...
        if (sis != null) {
            ...
            try {
                ...
                OpenGlHelper.setLightmapTextureCoords(
                    OpenGlHelper.lightmapTexUnit, var11, var12
                );
