...
public class RenderBlockSkyChest extends BaseBlockRender<BlockSkyChest, TileSkyChest> {
    ...
    private static final ResourceLocation SKY_BLOCK_CHEST = new ResourceLocation(
        "appliedenergistics2", "textures/models/skyblockchest.png"
    );
    private static final ResourceLocation[] METADATA_TO_TEXTURE
        = { SKY_STONE_CHEST, SKY_BLOCK_CHEST };
    ...
    public void renderTile(
        ...
        final int metaData = skyChest.getWorldObj().getBlockMetadata(
            skyChest.xCoord, skyChest.yCoord, skyChest.zCoord
        );
        final ResourceLocation loc = METADATA_TO_TEXTURE[metaData];
