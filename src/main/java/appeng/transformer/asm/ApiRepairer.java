...
/*
 * It is a ClassTransformer which can transformer the older AE2 api class that some addons
 * including, which can occur the crash due to java.lang.NoSuchMethodError. See also :
    ...
    public byte[] transform(String name, String transformedName, byte[] basicClass) {
        if (transformedName.startsWith("appeng.api")) {
            try {
                ...
                clazzurl = clazzurl.substring(0, clazzurl.length() - 23)
