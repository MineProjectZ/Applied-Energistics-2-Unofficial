...
public class BlockCraftingUnit extends AEBaseTileBlock {
    ...
    protected RenderBlockCraftingCPU<? extends BlockCraftingUnit, ?
    ...
    public boolean onBlockActivated(
        ...
        if (tg != null && !p.isSneaking() && tg.isFormed() && tg.isActive()) {
            ...
            Platform.openGUI(
                p, tg, ForgeDirection.getOrientation(side), GuiBridge.GUI_CRAFTING_CPU
            );
            return true;
        }
    ...
    public void setRenderStateByMeta(final int itemDamage) {
        ...
        this.getRendererInstance().setTemporaryRenderIcons(
            other, other, front, other, other, other
        );
    }
