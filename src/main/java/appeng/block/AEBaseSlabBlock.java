...
public class AEBaseSlabBlock extends BlockSlab implements IAEFeature {
    ...
    public AEBaseSlabBlock(
        ...
        if (!this.field_150004_a) {
            this.doubleSlabs
                = new AEBaseSlabBlock(block, meta, features, true, name + ".double")
                      .setSlabs(this);
        }
        this.features
            = !this.field_150004_a ? new SlabBlockFeatureHandler(features, this) : null;
    }
    ...
    public Item getItemDropped(final int meta, final Random rand, final int fortune) {
        return this.field_150004_a ? Item.getItemFromBlock(this.slabs)
