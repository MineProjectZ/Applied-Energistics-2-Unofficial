...
public class BlockCableBus extends AEBaseTileBlock implements IRedNetConnection {
    ...
    public void onEntityCollidedWithBlock(
        final World w, final int x, final int y, final int z, final Entity e
    ) {
    ...
    @Override
    public int
    getLightValue(final IBlockAccess world, final int x, final int y, final int z) {
    ...
    @Override
    public boolean
    isReplaceable(final IBlockAccess world, final int x, final int y, final int z) {
    ...
    public boolean recolourBlock(
        ...
        try {
            return this.cb(world, x, y, z)
                .recolourBlock(side, AEColor.values()[colour], who);
    ...
    protected void setFeature(final EnumSet<AEFeature> f) {
        final AECableBusFeatureHandler featureHandler
            = new AECableBusFeatureHandler(f, this, this.featureSubName);
    ...
    public void setupTile() {
        ...
        if (Platform.isClient()) {
            tesrTile = Api.INSTANCE.partHelper().getCombinedInstance(
                TileCableBusTESR.class.getName()
            );
    ...
    public RedNetConnectionType getConnectionType(
        ...
        return this.cb(world, x, y, z)
                   .canConnectRedstone(EnumSet.allOf(ForgeDirection.class))
