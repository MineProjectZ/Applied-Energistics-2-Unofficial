...
public abstract class IC2 extends AERootPoweredItem implements IElectricItemManager, ISpecialElectricItem
{
    ...
    public double charge(
        ...
        return addedAmt
            - ((int) this.injectExternalPower(PowerUnits.EU, is, addedAmt, simulate));
    }
    ...
    @Override
    public boolean
    use(final ItemStack is, final double amount, final EntityLivingBase entity) {
    ...
    @Override
    public void
    chargeFromArmor(final ItemStack itemStack, final EntityLivingBase entity) {
        // wtf?
    }
