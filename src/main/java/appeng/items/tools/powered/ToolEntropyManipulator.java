...
public class ToolEntropyManipulator extends AEBasePoweredItem implements IBlockTool {
    ...
    private final Map<InWorldToolOperationIngredient, InWorldToolOperationResult>
        coolDown;
    ...
    public ToolEntropyManipulator() {
        ...
        this.heatUp
            = new HashMap<InWorldToolOperationIngredient, InWorldToolOperationResult>();
        this.coolDown
            = new HashMap<InWorldToolOperationIngredient, InWorldToolOperationResult>();
        ...
        this.coolDown.put(
            new InWorldToolOperationIngredient(
                Blocks.flowing_lava, OreDictionary.WILDCARD_VALUE
            ),
            new InWorldToolOperationResult(new ItemStack(Blocks.obsidian))
        );
        this.coolDown.put(
            new InWorldToolOperationIngredient(
                Blocks.grass, OreDictionary.WILDCARD_VALUE
            ),
        ...
        this.coolDown.put(
            new InWorldToolOperationIngredient(
                Blocks.flowing_water, OreDictionary.WILDCARD_VALUE
            ),
            new InWorldToolOperationResult(null, snowBalls)
        );
        this.coolDown.put(
            new InWorldToolOperationIngredient(
                Blocks.water, OreDictionary.WILDCARD_VALUE
            ),
    ...
    private static final boolean breakBlockWithCheck(
        ...
        BlockEvent.BreakEvent event = new BlockEvent.BreakEvent(
            x, y, z, w, w.getBlock(x, y, z), w.getBlockMetadata(x, y, z), p
        );
    ...
    private boolean heat(
        ...
        InWorldToolOperationResult r
            = this.heatUp.get(new InWorldToolOperationIngredient(blockID, metadata));

        if (r == null) {
            r = this.heatUp.get(
                new InWorldToolOperationIngredient(blockID, OreDictionary.WILDCARD_VALUE)
            );
        }
    ...
    private boolean cool(
        ...
        InWorldToolOperationResult r
            = this.coolDown.get(new InWorldToolOperationIngredient(blockID, metadata));
    ...
    public boolean hitEntity(
        final ItemStack item, final EntityLivingBase target, final EntityLivingBase hitter
    ) {
    ...
    onItemRightClick(final ItemStack item, final World w, final EntityPlayer p) {
        final MovingObjectPosition target
            = this.getMovingObjectPositionFromPlayer(w, p, true);
            ...
            if (p.isSneaking()) {
                ...
                for (final ItemStack i : stack) {
                    final ItemStack result
                        = FurnaceRecipes.smelting().getSmeltingResult(i);
                ...
                if (hasFurnaceable && canFurnaceable) {
                    ...
                    final InWorldToolOperationResult or
                        = InWorldToolOperationResult.getBlockOperationResult(
                            out.toArray(new ItemStack[out.size()])
                        );
                    w.playSoundEffect(
                        x + 0.5D,
                        y + 0.5D,
    ...
    private static class InWorldToolOperationIngredient {
        ...
        public boolean equals(final Object obj) {
            ...
            final InWorldToolOperationIngredient other
                = (InWorldToolOperationIngredient) obj;
