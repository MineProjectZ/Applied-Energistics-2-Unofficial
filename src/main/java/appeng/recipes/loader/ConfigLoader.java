...
public final class ConfigLoader implements IRecipeLoader {
    ...
    @Override
    public BufferedReader getFile(@Nonnull final String relativeFilePath)
        throws Exception {
        ...
        final File toBeLoaded
            = (userFile.exists() && userFile.isFile()) ? userFile : generatedFile;

        return new BufferedReader(
            new InputStreamReader(new FileInputStream(toBeLoaded), "UTF-8")
        );
    }
}
