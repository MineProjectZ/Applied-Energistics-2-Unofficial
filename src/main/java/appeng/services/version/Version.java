...
public interface Version {
     ...
     * if revision are equal and the current channel is higher than the compared channel
     * (Stable > Beta > Alpha) OR if revision, channel are equal and the build is higher
     * than the compared build
     *
