...
/**
 * Wrapper for {@link VersionParser} to check if the check is happening in developer
 * environment or in a pull request. <p> In that case ignore the check.
 */
public final class ModVersionFetcher implements VersionFetcher {
    ...
    public ModVersionFetcher(
        @Nonnull final String rawModVersion, @Nonnull final VersionParser parser
    ) {
     ...
     *
     * @return {@link DoNotCheckVersion} if in developer environment or pull request,
     *     {@link MissingVersion} in case of
