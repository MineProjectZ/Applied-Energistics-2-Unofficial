...
public final class VersionParser {
     ...
     */
    private String transformDelimiter(@Nonnull final String raw)
    ...
    private Version parseVersion(@Nonnull final String[] splitRaw)
        throws InvalidVersionException, InvalidRevisionException, InvalidChannelException,
     ...
     */
    private int parseRevision(@Nonnull final String rawRevision)
     ...
     */
    private Channel parseChannel(@Nonnull final String rawChannel)
