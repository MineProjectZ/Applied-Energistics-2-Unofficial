...
public final class ForgeExportConfig implements ExportConfig {
    ...
    /**
     * Constructor using the configuration. Apparently there are some race conditions if
     * constructing configurations on multiple file accesses
     *
    ...
    public ForgeExportConfig(@Nonnull final Configuration config) {
        ...
        this.cache = this.config.getString(
            DIGEST_KEY, CACHE_CATEGORY, DIGEST_DEFAULT, DIGEST_DESCRIPTION
        );
    ...
    public void setCache(@Nonnull final String digest) {
        final Property digestProperty
            = this.config.get(CACHE_CATEGORY, DIGEST_KEY, DIGEST_DEFAULT);
