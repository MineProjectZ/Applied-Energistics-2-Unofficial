...
public final class CompassReader {
    private final Map<Long, CompassRegion> regions
        = new HashMap<Long, CompassRegion>(100);
    ...
    public void
    setHasBeacon(final int cx, final int cz, final int cdy, final boolean hasBeacon) {
